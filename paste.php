...
<main class="container py-5 app-wrap">
    <div class="app-nav">
        ...
        <div class="app-nav-controls">
            <a class="btn btn-sm btn-outline-secondary" href="<?= htmlspecialchars(app_url('paste.php?code=' . urlencode($code) . '&lang=en'), ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars(t('ui.lang.en'), ENT_QUOTES, 'UTF-8') ?></a>
            <a class="btn btn-sm btn-outline-secondary" href="<?= htmlspecialchars(app_url('paste.php?code=' . urlencode($code) . '&lang=fa'), ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars(t('ui.lang.fa'), ENT_QUOTES, 'UTF-8') ?></a>
